...
const VIEW_COPY = {
  overview: {
    title: '百年获奖节奏与学科版图',
    insight: '这张图先给出诺奖的整体节奏：得奖人数趋势总体上升，但并不是线性增加；战争会让奖项直接断档，而科学类奖项长期构成主体。',
    notes: [
  ...
  migration: {
    title: '从出生地出发的学术迁徙',
    insight: '这里看的不是“人来自哪里”，而是“知识在哪里被完成”。许多获奖者离开出生国，在更强的学术网络中完成关键研究。',
    notes: [
  ...
  centers: {
    title: '学术中心的时代转移',
    insight: '获奖不是只靠个人冲刺，也需要进入高密度的科研环境。图中可以看到战后美国逐渐成为最稳定的学术中心。',
    notes: [
  ...
  identity: {
    title: '历史国名里的现代国家',
    insight: '同一个出生地，在不同年代可能属于不同政体。获奖者的国名记录因此像一层历史切片，保留了帝国解体和国家重组的痕迹。',
    notes: [
  ...
  periods: {
    title: '奖项河流中的时代断点',
    insight: '奖项演进不是平稳流水线。战争会制造停发和低谷，而冷战、全球化等时期会改变不同学科被看见的机会。',
    notes: [
